module Erp::Hoanmy
  class Project < ApplicationRecord
    ...
    def self.get_project_status_options()
      [
        {text: I18n.t('.processing'), value: Erp::Hoanmy::Project::PROCESSING},
        {text: I18n.t('.completed'), value: Erp::Hoanmy::Project::COMPLETED}
      ]
    end
    ...
    def get_first_image
			if self.project_images.count > 0
				self.project_images.first.image_url
			end
		end
    
    def self.get_projects(params)
			query = self.all
			query = query.order('erp_hoanmy_projects.created_at DESC')
    end
  end
end
